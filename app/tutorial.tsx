        ...
        <View style={Style.innerContainer}>
          ...
          <View style={{ alignItems: 'center', justifyContent: 'center' }}>
            ...
            <Text style={{ textAlign: 'center', paddingVertical: 10 }}>RRate helps healthcare providers accurately measure a patient's respiratory rate. Compared to traditional methods,
              RRate is faster, easy to use, and reduces the risk of measurement errors.</Text>
          </View>
          <View style={{ flexGrow: 2, flexDirection: 'column', justifyContent: 'center', alignItems: 'center', paddingVertical: 10, gap: 15 }}>
            ...
            <View style={[Style.tutorialBox, { backgroundColor: "rgba(39, 92, 172, 0.20)" }]}>
              ...
              <Text style={{ textAlign: 'center', paddingVertical: 10 }}>Once RRate has calculated a consistent respiratory rate, it displays the rate alongside an animation of a baby breathing
                at that rate. Use the animation to visually compare with the patient’s breathing. Tap on the animation to sync the it with the patient's inhalation.</Text>
            </View>
            <View style={[Style.tutorialBox, { backgroundColor: "rgba(39, 92, 172, 0.30)" }]}>
              ...
              <Text style={{ textAlign: 'center', paddingVertical: 10 }}>RRate determines a rate based on the previous {tapCountRequired} consistent taps. The consistency analysis chart
